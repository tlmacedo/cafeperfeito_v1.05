...
public class ServiceNumeroExtenso {
    ...
    public ServiceNumeroExtenso() {
        nro = new ArrayList();
    }

    public ServiceNumeroExtenso(BigDecimal dec) {
        this();
        setNumber(dec);
    }

    public ServiceNumeroExtenso(double dec) {
        this();
        setNumber(dec);
    }
    ...
    public void setNumber(BigDecimal dec) {
        ...
        num = dec.setScale(2).multiply(BigDecimal.valueOf(100)).toBigInteger();
        // Adiciona valores
        nro.clear();
