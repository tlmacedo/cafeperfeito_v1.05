...
public class SetCellFactoryTreeTableCell_DatePicker<S> extends TreeTableCell<S, LocalDate> {

    private JFXDatePicker picker;
    private DateTimeFormatter formatter;

    public SetCellFactoryTreeTableCell_DatePicker() {
        this(null);
     ...
     */
    public SetCellFactoryTreeTableCell_DatePicker(DateTimeFormatter formatter) {
