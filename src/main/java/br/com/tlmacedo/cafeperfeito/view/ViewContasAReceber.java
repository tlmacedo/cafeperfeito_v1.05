...
public class ViewContasAReceber {
    ...
    public static void setTituloJanela(String tituloJanela) {
        ViewContasAReceber.tituloJanela = tituloJanela;
    }
    ...
    public Tab openTabContasAReceber(String tituloJanela) {
        setTituloJanela(tituloJanela);
        Parent parent;
        try {
            parent = FXMLLoader.load(getClass().getResource(ServiceVariaveisSistema.TCONFIG.getFxml().getContasAReceber().getFxml()));
